...
class CardataAnalyticsMapCard extends HTMLElement {
  ...
  _applyPoiTemplate(key) {
    ...
    this._poiRadiusKm = [2, 5, 10, 25, 50].includes(Number(template.radiusKm)) ? Number(template.radiusKm) : 5;
  ...
  _poiStatusText() {
    ...
    if (this._poiLoading) return "POIs werden über Home Assistant geladen …";
