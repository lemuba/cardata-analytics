      ...
      <ha-card>
        <div class="map-card-shell">
          ...
          <div class="toolbar">
            ...
            <button class="tool-btn" id="ranges-toggle" title="Restreichweiten aller Fahrzeuge ein-/ausblenden"><ha-icon icon="mdi:map-marker-radius-outline"></ha-icon><span>Reichweite</span></button>
            <button class="tool-btn" id="fit-ranges" title="Alle eingeblendeten Restreichweiten einpassen"><ha-icon icon="mdi:arrow-expand-all"></ha-icon><span>Bereich</span></button>
            ...
            <button class="tool-btn" id="route-toggle" title="Route mit POI-Zwischenzielen planen"><ha-icon icon="mdi:map-marker-path"></ha-icon><span>Route</span></button>
          </div>
          <div class="map-wrap">
