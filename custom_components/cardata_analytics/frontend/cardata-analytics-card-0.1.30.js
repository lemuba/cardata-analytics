...
class CardataAnalyticsMapCard extends HTMLElement {
  ...
  _renderPoiPanel() {
    ...
    panel.innerHTML = `
      ...
      <div class="poi-note">Allgemeine POIs © OpenStreetMap-Mitwirkende · Ladestationen: AFIR/Mobilithek · Datenlieferant Eco-Movement (CC BY 4.0) + Bundesnetzagentur.de (CC BY 4.0), OSM nur Fallback · Filter/Vorlagen lokal gespeichert · Cardata ${CARD_VERSION}.</div>`;
