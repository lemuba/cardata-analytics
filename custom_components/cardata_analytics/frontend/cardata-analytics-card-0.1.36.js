...
class CardataAnalyticsMapCard extends HTMLElement {
  ...
  _poiDefinitions() {
    return {
      ...
      restaurant: {
        ...
        // OSM maps McDonald's, Burger King, Subway etc. as amenity=fast_food.
        // food_court is included as the same user-facing food category.
  ...
  _renderPoiMarkers(topLeft, width, height, n) {
    ...
    // features rendered and clustered directly by MapLibre in 0.1.36+.
