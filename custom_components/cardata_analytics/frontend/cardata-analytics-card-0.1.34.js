...
class CardataAnalyticsMapCard extends HTMLElement {
  ...
  _renderPoiPanel() {
    ...
    panel.innerHTML = `
      ...
      <div class="poi-note">Allgemeine POIs © OpenStreetMap-Mitwirkende · Ladestationen: Open Charge Map, serverseitig gecacht · kein Overpass-Fallback für Ladepunkte · Filter/Vorlagen lokal gespeichert · Cardata ${CARD_VERSION}.</div>`;
