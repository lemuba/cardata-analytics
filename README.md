...
Version 0.1.36 is the current separate interactive vehicle map:
...
Available POI categories in 0.1.36:

- EV charging stations
- Fuel stations
- Vehicle workshops / car repair
- Restaurants (including OSM fast-food/food-court POIs such as McDonald's and Burger King)
- Cafés
- Parking
- Supermarkets
- Hotels
...
POI filters in 0.1.36 can be combined freely. In addition to category and radius, the panel supports:
...
Custom presets store the selected categories, radius, text/operator filters, connector, minimum power and unknown-power option. They intentionally remain browser-local in 0.1.36; this keeps the analytics/ledger backend untouched.
